...
smc.filterType     = "fullyadapted";   # bootstrap or fullyadapted
smc.smootherType   = "fixedlag";       # filtersmoother or fixedlag
smc.flVersion      = "full";           # filtersmoother or full
smc.fixedLag       = 12;
smc.onlydiagInfo   = 0;
smc.makeInfoPSD    = 1;
...
#pmh0.writeToFile("results/lgss-fapf/pmh0.csv",par);
#pmh1.writeToFile("results/lgss-fapf/pmh1.csv",par);
#pmh2.writeToFile("results/lgss-fapf/pmh2.csv",par);
